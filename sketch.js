...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 10 , {restitution:0.1, isStatic:true});
	World.add(world, packageBody);

	packageBody1 = Bodies.circle(width/2 , 200 , 10 , {restitution:0.1, isStatic:true});
	World.add(world, packageBody);

	packageBody2 = Bodies.circle(width/2 , 200 , 15 , {restitution:0.1, isStatic:true});
	World.add(world, packageBody);
